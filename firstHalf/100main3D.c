...
void colorPixel(renRenderer *ren, double unif[], texTexture *tex[],
    ...
    rgb[0] = tex[0]->sample[texIndexR] * unif[renUNIFR];
    rgb[1] = tex[0]->sample[texIndexG] * unif[renUNIFG];
    rgb[2] = tex[0]->sample[texIndexB] * unif[renUNIFB];
}
...
int main(void) {
    ...
    if (pixInitialize(1024, 1024, "3D!") != 0)
		return 1;
	else {
        ...
        meshInitializeSphere(meshA, unifA[renUNIFRADIUS], 60, 40);
